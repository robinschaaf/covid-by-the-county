...
SpinnerService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_loading_service__WEBPACK_IMPORTED_MODULE_3__["LoadingService"]])
], SpinnerService);
...
class TextViewService {
    constructor() {
        this.getId = () => 'textViews';
        this.getTitle = () => 'Typo + small components';
        this.getAllThemes = () => {
            return [
