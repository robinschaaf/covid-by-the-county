(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-settings-page-settings-page-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesSettingsPageModalPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesSettingsPageSettingsPagePageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesSettingsPageModalPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ModalPage = /*#__PURE__*/function () {
        function ModalPage(modalController, restangular) {
        ...
        _createClass(ModalPage, [{
          ...
          key: "onChangedPushEnabled",
          value: function onChangedPushEnabled(event) {
            this.county.enabled = this.county.enabled === 1 ? 0 : 1;
          }
        }, {
          key: "onChangeCountyDefaultDays",
          value: function onChangeCountyDefaultDays(e) {
            this.county.default_days = e.detail.value;
          }
        }, {
          key: "saveAndCloseModal",
          value: function saveAndCloseModal() {
      ...
      ModalPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/settings-page/modal.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./settings-page.page.scss */
        "./src/app/pages/settings-page/settings-page.page.scss"))["default"]]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], ngx_restangular__WEBPACK_IMPORTED_MODULE_3__["Restangular"]])], ModalPage);
      /***/
    },
    ...
    function srcAppPagesSettingsPageSettingsPageModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _settings_page_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./settings-page.page */
      ...
      SettingsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        _components_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forChild([{
          path: '',
    ...
    /***/
    function srcAppPagesSettingsPageSettingsPagePageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesSettingsPageSettingsPagePageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ramda__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ramda */
      "./node_modules/ramda/es/index.js");

      var SettingsPage = /*#__PURE__*/function () {
        function SettingsPage(settingsService, restangular, toastCtrl, navCtrl, modalController) {
          ...
          this.defaultSettings = {
            ...
            perChecked: true,
            defaultDays: 10
          }; //TODO: if this is updated also update server!

          this.settings = localStorage.getItem('_appSettings') ? Object(ramda__WEBPACK_IMPORTED_MODULE_7__["merge"])(this.defaultSettings, JSON.parse(localStorage.getItem('_appSettings'))) : this.defaultSettings;
          this.deathsChecked = true;
          this.perChecked = true;
          this.defaultDays = this.settings.defaultDays;
          this.allowedDays = [];
          this.counties = localStorage.getItem('counties') ? JSON.parse(localStorage.getItem('counties')) : [];
        ...
        _createClass(SettingsPage, [{
          ...
          key: "ionChangeDeathsChecked",
          value: function ionChangeDeathsChecked(event) {
            this.deathsChecked = !this.deathsChecked;
            this.settings.deathsChecked = this.deathsChecked;
            this.saveSettings();
          }
        }, {
          key: "ionChangePerChecked",
          value: function ionChangePerChecked(event) {
            this.perChecked = !this.perChecked;
            this.settings.perChecked = this.perChecked;
            this.saveSettings();
          }
        }, {
          key: "onChangeDefaultDays",
          value: function onChangeDefaultDays(event) {
            this.settings.defaultDays = this.defaultDays;
            this.saveSettings();
          }
        }, {
          key: "getUserCounties",
          value: function getUserCounties() {
            var _this2 = this;
            ...
            this.restangular.all('/userCounties').getList({
              userId: this.userId
            }).subscribe(function (co) {
              _this2.counties = co.map(function (c) {
                return Object(ramda__WEBPACK_IMPORTED_MODULE_7__["merge"])(c, {
                  checkEnabled: c.enabled === 1
                });
              });
            });
          }
          ...
          value: function saveSettings() {
            ...
            this.restangular.all('/updateUserSettings').post({
              user_id: this.userId,
              settings: JSON.stringify(this.settings)
            }).subscribe(function (r) {
              _this3.toastCtrl.presentToast('Settings have been updated', 2000);
            });
          }
        }, {
          key: "openModal",
          value: function openModal(county) {
      ...
      SettingsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./settings-page.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/settings-page/settings-page.page.html"))["default"],
        providers: [],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./settings-page.page.scss */
        "./src/app/pages/settings-page/settings-page.page.scss"))["default"]]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_settings_service__WEBPACK_IMPORTED_MODULE_5__["SettingsService"], ngx_restangular__WEBPACK_IMPORTED_MODULE_3__["Restangular"], src_app_services_toast_service__WEBPACK_IMPORTED_MODULE_4__["ToastService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"]])], SettingsPage);
      /***/
    }
  }]);
})();
